    ...
    <body style="height: 100vh">
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-12 col-lg-4 d-flex align-items-center justify-content-center posicion-bienvenidos">
                    <div class="container-ofertas">
                        <div class="row">
                            <div class="col-12 text-center">
                                <img class="bienvenido-img" src="images/bienvenido-ofertas.png" alt="">
                            </div>
                            <div class="col-12" style="display: ruby">
                                ...
                                <select name="" id="">
                                    ...
                                    @foreach ($zona as $zonas)
                                        <option value="{{$zonas->id}}">{{$zonas->nombre_zona}}</option>
                                    @endforeach
                                </select>
                                <select name="" id="">
                                    <option value="" selected>Selecciona tu tienda</option>
                                    @foreach ($sucursal as $sucursales)
                                        <option value="{{$sucursales->id}}">{{$sucursales->nombre_sucursal}}</option>
                                    @endforeach
                                </select>
                                <button>
                                    <p>Conoce las ofertas</p>
                                    <img src="images/flecha-pequena-derecha-blanco.svg" alt="">
                                </button>
                            </div>
